...
class MobileNetV1PPNBranchBackbone(BackboneNetwork):
    def __init__(self, data_format='channels_last',depth_multiplier=0.5):
        super(MobileNetV1PPNBranchBackbone, self).__init__()
    ...
    def forward(self, inputs, is_training=False):
        ...
        with tf.variable_scope('MobilenetV1') as scope:
            ...
            conv2d_11_upsample=self.upsample(image_features['Conv2d_10_pointwise'],2,name='Conv2d_11_pointwise_upsample')
            ...
            # features_concat = self.separable_conv(features_concat, 3, 3, 192, 1,
            #                                       name=prefix + '_L_1')
            ...
            features.append(image_features['Conv2d_11_pointwise'])
...
if __name__ == '__main__':
    #192x192x0.25=155.44M flops 192x192x0.5=337.64M flops 160x160x0.25=108M flops 160x160x0.5=234.47M flops 128x128x0.5=150.06M 128x128x0.25=69.1M
