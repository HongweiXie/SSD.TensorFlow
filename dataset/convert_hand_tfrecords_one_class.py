...
tf.app.flags.DEFINE_string('output_directory', '/home/sixd-ailabs/Develop/Human/Hand/diandu/test/tf_record_one_class',
...
def _find_image_bounding_boxes(directory, cur_record):
  ...
  Returns:
    ...
    truncated: List of ints indicate the truncation of that bounding box.
  """
  anna_file = os.path.join(directory, cur_record[0], cur_record[1].replace('jpg', 'xml'))
